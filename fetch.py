#!/usr/bin/env python3
"""
Recupero codici sconto Booking.com da shopilo.it
Sursa: https://shopilo.it/negozi/booking.com
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/booking.com"
STORE_NAME = "Booking.com"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Booking.com da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-booking)"
    }
    try:
