 ...
 * Homepage: https://shopilo.it/negozi/booking.com
 */

const SHOPILO_URL = "https://shopilo.it/negozi/booking.com";
const STORE_NAME  = "Booking.com";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-it/codice-sconto-booking)" }
  });
